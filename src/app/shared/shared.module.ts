...
import { PageFootherComponent } from './components/page-foother/page-foother.component';
...
const PIPES = [SafeUrlPipe, ToObservablePipe, SearchFilterPipe];

@NgModule({
  declarations: [...COMPONENTS, ...COMPONENTS_DYNAMIC, ...DIRECTIVES, ...PIPES, PageFootherComponent],
